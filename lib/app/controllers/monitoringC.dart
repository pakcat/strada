...
import 'package:gostrada/app/data/models/absen_m.dart';
import 'package:gostrada/app/data/models/monitoringmodel.dart';
...
class MonitoringController extends GetxController {
  GetJadwalAbsensi(String nim) async {
    ...
    var response = await http.post(
        Uri.parse(
            "https://sia.iik-strada.ac.id/mobile/monitoring/list_perkuliahan"),
        body: dataBody);
  ...
  GetAbsen(String nim) async {
    ...
    var response = await http.post(
        Uri.parse(
            "https://sia.iik-strada.ac.id/mobile/monitoring/detail_absensi"),
        body: dataBody);
  ...
  GetDetailJadwal(String nim) async {
    ...
    var response = await http.post(
        Uri.parse(
            "https://sia.iik-strada.ac.id/mobile/monitoring/detail_jadwal"),
        body: dataBody);
  ...
  GetDetailAbsensi(String nim) async {
    ...
    var response = await http.post(
        Uri.parse(
            "https://sia.iik-strada.ac.id/mobile/monitoring/menu_absensi"),
        body: dataBody);
