...
import 'package:gostrada/app/data/models/profile.dart';
...
class ProfileController extends GetxController {
  ...
  onInit() async {
    ...
    var response = await http.post(
        Uri.parse("https://sia.iik-strada.ac.id/mobile/profile/get_profile"),
        body: dataBody);
  ...
  ganti_password(String id, String nim, String username, String oldpwd,
    ...
    var request = http.MultipartRequest('POST',
        Uri.parse('https://sia.iik-strada.ac.id/mobile/profile/save_profile'));
